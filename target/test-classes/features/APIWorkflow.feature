...
Description: This feature tests and verifies Syntax HRMS Workflow
...
And the retrieved employee ID at "employee[0].employee_id" matches the gloally stored employee ID
...
|Abuzer       |               |Killi       |2000-01-01  |Male      |Cloud Architect|Employee  |